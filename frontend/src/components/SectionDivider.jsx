 ...
 *
 * Props:
 *   variant  – "wave" | "wave2" | "tilt" | "curve" | "peaks"  (default: "wave")
 *   from     – Tailwind bg token for the section ABOVE         (default: "bg-white dark:bg-dark-900")
 *   to       – Tailwind bg token for the section BELOW         (default: "bg-surface-100 dark:bg-dark-950")
 *   flip     – mirror the shape horizontally                   (default: false)
 *   height   – svg viewBox height in px                        (default: 60)
 *   accent   – draw as a soft brand-colour stroke (no fill)    (default: false)
 */
export default function SectionDivider({
  ...
  function resolveColor(token, isDark = false) {
